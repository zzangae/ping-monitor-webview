...
// Load Configuration
// ============================================================================
BOOL LoadOutageConfiguration(const wchar_t *configPath, OutageSettings *config)
{
    if (!config)
        return FALSE;
...
// Save Configuration
// ============================================================================
BOOL SaveOutageConfiguration(const wchar_t *configPath, const OutageSettings *config)
{
    if (!config)
        return FALSE;
...
// ============================================================================
void ExportConfigJSON(const OutageSettings *config, wchar_t *jsonBuffer, int bufferSize)
{
...
// ============================================================================
BOOL ImportConfigJSON(const wchar_t *jsonString, OutageSettings *config)
{
